...
{
    public static final String CLIENT_ID = "00";
    private static final String APP_SHARED_PREFS = SPAdapter.class.getSimpleName(); // Name of the file -.xml
    ...
    {
        String[] values = _sharedPrefs.getString(CLIENT_ID, "00").split("-");
