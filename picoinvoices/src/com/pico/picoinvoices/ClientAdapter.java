...
public class ClientAdapter
{
    ...
    public static final String[] ALL_KEYS = new String[] { KEY_ROWID,
            KEY_FNAME, KEY_LNAME, KEY_ADDRESS, KEY_PHONE, KEY_EMAIL,
            KEY_BUSINESS };
    ...
    public long insertRow(String fname, String lname, String address,
            String phone, String email, String business)
    {
        // ContentValues use variable binding behind the scenes and therefore do
    ...
    public boolean updateRow(long rowId, String fname, String lname,
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        {
            // This is handled in the DBAdapter on App startup to ensure that
            // the database exists/is created on startup
        }
        ...
        {
            // This is handled in the DBAdapter on App startup to ensure that
            // the database exists/is upgraded on startup
        }
    }
}
