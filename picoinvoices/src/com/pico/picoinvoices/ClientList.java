...
public class ClientList extends Activity
{
    ...
    private void populateListView()
    {
        ...
        //
        // ArrayAdapter<String> adapter = new ArrayAdapter<String>( //Build the
        // adapter
        ...
        int[] ints = new int[] { R.id.txt_dbID, R.id.txt_clientFName,
                R.id.txt_clientLName };
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(this,
                R.layout.client_name, cursor, client_name_list, ints);
                    ...
                    int position, long idInDB)
            {
                ...
                if (cursor.moveToFirst())
                {
                    ...
                    String address = cursor
                            .getString(ClientAdapter.COL_ADDRESS);
                    ...
                    Toast.makeText(ClientList.this, "failed to load" + idInDB,
